  ...
  <?php
    ...
    <script>
                        function fk(){
                          ...
                          if(a=="Fakultas Agama Islam"){
                            var array=["Ilmu Hadis","Bahasa dan Sastra Arab","Pendidikan Agama Islam","Perbankan Syariah"];
                          }else if (a=="Fakultas Teknologi Industri"){
                            var array=["Teknik Informatika","Teknik Industri","Teknik Kimia","Teknik Elektro","Teknik Informatika Prosus","Teknologi Pangan"];
                          }else if (a=="Fakultas Farmasi"){
                            var array=["Farmasi","Profesi Apoteker"];
                          }else if (a=="Fakultas Hukum"){
                            var array=["Ilmu Hukum"];
                          }else if (a=="Fakultas Ekonomi"){
                            var array=["Ekonomi Pembangunan","Manajemen","Akuntansi","Manajemen Prosus","Bisnis Jasa Makanan"];
                          }else{
                            var array=[];
                          }
                          var string="";
                          ...
                          string="<select style=width:300px;>"+string+"</select>";
                          document.getElementById('outfk').innerHTML=string;
                        }
      </script>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    ...
    <div class="jumbotron">
      ...
      <div class="row" style="width: 500px;">
        ...
        <table class="table" >
            ...
            <tbody>
                <tr>
                    <td><h1>JADWAL KULIAH</h1></td>
                </tr>
                <tr >
                    <td><h4>FAKULTAS</h4></td>
                    <td>
                    <select id="input" onchange="fk()" style="width: 300px;">
                        <option>PILIH</option>
                ...
                <tr>
                  ...
                  <table width="800">
                    <tr>
                      <td>HARI</td><td>KODE</td><td>MATA KULIAH</td><td>KELAS</td><td>SKS</td><td>JAM</td><td>SEMESTER</td><td>DOSEN</td><td>RUANG</td>
                    </tr>
                  </table>
                  </td>
                </tr>
